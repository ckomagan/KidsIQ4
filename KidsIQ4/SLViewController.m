...
{
    self = [super initWithNibName:@"SLViewController" bundle:nibBundleOrNil];
    if (self) {
        // Custom initialization
    }
    self.postParams =
    [[NSMutableDictionary alloc] initWithObjectsAndKeys:
     @"https://itunes.apple.com/us/app/kidsiqtablet/id568600066?mt=8", @"link",
     @"http://komagan.com/KidsIQ/kidsiq_114x114.jpg", @"picture",
     @"KidsIQ iPad App", @"name",
     @"Quiz App for Kids and Adults", @"caption",
     @"Challenge your IQ by taking this test with questions ranging from General Knowledge to Science and Math!", @"description",
     nil];
    return self;
}
...
- (void)viewDidLoad {
    ...
    KidsIQ4AppDelegate *appDelegate = [[UIApplication sharedApplication]delegate];
    ...
    postMessageTextView.font = [UIFont systemFontOfSize: 22.0];
...
- (IBAction)publishButtonAction:(id)sender {
    SLViewController *viewController = [[SLViewController alloc]
                                           initWithNibName:@"SLViewController"
                                           bundle:nil];
